...
<body>
<form method="POST" action="StudentController" onsubmit="return validateForm()">
	...
	<script>
		function validateForm() {
			...
			password.removeChild(password.childNodes[0]);
