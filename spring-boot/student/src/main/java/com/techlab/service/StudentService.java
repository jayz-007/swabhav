...
public class StudentService {
	...
	private StudentService() {
		...
		addStudent(new Student(null, "jay", "india", 58));
		addStudent(new Student(null, "saurab", "australia",70 ));
		addStudent(new Student(null, "Jake", "USA", 15));
		addStudent(new Student(null, "Dishank", "UK", 85));
	}
